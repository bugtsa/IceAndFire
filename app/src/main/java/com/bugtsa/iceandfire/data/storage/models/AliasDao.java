...
public class AliasDao extends AbstractDao<Alias, Long> {
    ...
    */
    ...
    private Query<Alias> characterOfHouse_AliasesQuery;
    ...
    /** Internal query to resolve the "aliases" to-many relationship of CharacterOfHouse. */
    public List<Alias> _queryCharacterOfHouse_Aliases(String characterRemoteId) {
        synchronized (this) {
            if (characterOfHouse_AliasesQuery == null) {
                QueryBuilder<Alias> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.CharacterRemoteId.eq(null));
                characterOfHouse_AliasesQuery = queryBuilder.build();
            }
        }
        Query<Alias> query = characterOfHouse_AliasesQuery.forCurrentThread();
